...
public class CinemaTests extends SpringTest {
    ...
    private static void checkStatusCode(HttpResponse resp,
                                        int status) {
                               ...
                               isArray(
                                       ...
                                       isObject()
                                               ...
                                               .value("column",
                                                      isInteger(i -> i >= 1 && i <= 9))
                                               .value("price",
                                                      isInteger(price -> price == 10 || price == 8))
                               )
                        )
                        .value("total_columns",
                               9)
    ...
    CheckResult testPurchaseTicket() {
        ...
        JsonObject object = gson.fromJson(response.getContent(),
                                          JsonObject.class);
    ...
    CheckResult testTokenInvalidation() {
        ...
        JsonObject jsonResponse = gson.fromJson(response.getContent(),
                                                JsonObject.class);
    ...
    CheckResult testStats(int numberOfPurchasedTickets,
                          int currentIncome,
                          int availableSeats) {
        Map<String, String> requestParams = Map.of("password",
                                                   "super_secret");
        ...
        expect(response.getContent()).asJson().check(
                isObject()
                        .value("number_of_purchased_tickets",
